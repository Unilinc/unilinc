...
<head>
    ...
    <link rel="stylesheet" href="/project/css/statistics.css">
    <script type="text/javascript" src="/project/javascript/statistics.js"></script>
...
<body>
    ...
    <div class="Webcontainer" id="content-container">
        <div class="form_box">
            ...
            <form id="signup_form" style="display: flex;" onsubmit="return fetchStats(event)">
                ...
                <div class="button_box">
                    <button type="button" onclick="showTimeRange('semester')">Custom Date</button>
                </div>

                <div id="time_range_container"></div>

                <button type="submit" id="submit-button">Get Records</button>
            </form>
        </div>

        </div>

        <div class="popup" id="popup_message">Please fill in all required fields!</div>
