...
const data = {
    IFT: {
        levels: {
            "100 LEVEL": ["PMT 101", "CHM 101", "PMT 101"],
    ...
    SOE: {
        levels: {
            "100 LEVEL": ["Intro to PMTgramming", "Computer Fundamentals"],
    ...
    POT: {
        levels: {
            "100 LEVEL": ["Intro to CS", "Mathematics for CS"],
            "200 LEVEL": ["POT 201", "POT 202", "POT 203", "POT 204", "POT 205", "POT 206", "POT 207", "POT 208"],
            "300 LEVEL": ["POT 301", "POT 302", "POT 303", "POT 304", "POT 305", "POT 306", "POT 307", "POT 308"],
            "400 LEVEL": ["POT 401", "POT 402", "POT 403", "POT 404", "POT 405", "POT 406", "POT 407", "POT 408"],
            "500 LEVEL": ["POT 501", "POT 502", "POT 503", "POT 504", "POT 505", "POT 506", "POT 507", "POT 508"]
        }
    },
    PUH: {
        levels: {
    ...
    ENI: {
        levels: {
            "100 LEVEL": ["Intro to CS", "Mathematics for CS"],
            "200 LEVEL": ["ENI 201", "ENI 202", "ENI 203", "ENI 204", "ENI 205", "ENI 206", "ENI 207", "ENI 208"],
            "300 LEVEL": ["ENI 301", "ENI 302", "ENI 303", "ENI 304", "ENI 305", "ENI 306", "ENI 307", "ENI 308"],
            "400 LEVEL": ["ENI 401", "ENI 402", "ENI 403", "ENI 404", "ENI 405", "ENI 406", "ENI 407", "ENI 408"],
            "500 LEVEL": ["ENI 501", "ENI 502", "ENI 503", "ENI 504", "ENI 505", "ENI 506", "ENI 507", "ENI 508"]
        }
    },
    LTT: {
        levels: {
...
function updateLvl() {
    ...
    lvlSelect.innerHTML = '<option value="" disabled selected hidden>---Select---</option>';
    courseSelect.innerHTML = '<option value="" disabled selected hidden>---Select---</option>';

    if (selectedDept && data[selectedDept]) {
        const levels = data[selectedDept].levels;
...
function updateCourse() {
    ...
    if (selectedDept && selectedLevel && data[selectedDept].levels[selectedLevel]) {

        const courses = data[selectedDept].levels[selectedLevel];
